...
export default function RegisterPage() {
  ...
  // Redirect if user is already logged in - check immediately
  useEffect(() => {
      ...
      try {
        ...
        if (session?.user) {
          ...
          if (userData && userData.email_confirmed === true) {
            // User is logged in and email is confirmed, redirect immediately
  ...
  if (checkingAuth) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-accent-purple-50 via-white to-accent-green-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800">
